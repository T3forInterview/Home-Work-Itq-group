...
public class DocumentGeneratorUtility {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DocumentGeneratorUtility.class);
    ...
    public int generationDocument() {
        ...
        IntStream.range(0, n).forEach(i -> {
            ...
            try {
                ...
                logger.info("Сгенерирован документ: его автор: {}, имя документа: {}, всего {} документов сгенерировано",
                        document.getAuthor(), document.getName(), i + 1 );
